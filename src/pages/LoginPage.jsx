                ...
                {step === "mobile" && (
                    <div>
                        ...
                        <div className="flex items-center border border-green-400 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-green-400">
                            <div className="h-full px-3 py-2 bg-green-100 text-green-700 font-semibold">
                                +91
                            </div>
                            <input
                                type="text"
                        ...
                        <button
                            ...
                            className="w-full mt-5 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200 shadow-md"
                        >
                            Send OTP
                        </button>
                    </div>
                ...
                {step === "otp" && (
                    <div>
                        ...
                        <button
                            ...
                            className="w-full mt-5 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200 shadow-md"
                        >
                            Verify OTP
                        </button>
